...
<body>
    {{-- canvas for capturing frame of user camera --}}
    ...
    <script src="{{ asset('meet_resources/quickmeet/node_modules/socket.io-client/dist/socket.io.js') }}"></script>
    <script src="{{ asset('meet_resources/quickmeet/public/js/room.js') }}"></script>

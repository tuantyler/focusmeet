...
const SSL_CERT_PATH = "/Users/tuan.phan/Desktop/Yeez/ssl_configurations/certs/ssl.pem";
const SSL_KEY_PATH = "/Users/tuan.phan/Desktop/Yeez/ssl_configurations/certs/ssl-key.pem";
...
function processVideoStream(answer, sid) {
    const outputFolder = path.join(__dirname, 'frames', sid);
    ...
    const ffmpegCommand = ffmpeg()
        .input(answer.sdp)
        .inputFormat('sdp')
        .output(path.join(outputFolder, 'frame-%04d.png')) // Output format and path
        .on('end', () => {
